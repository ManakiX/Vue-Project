            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="skill-item mb-4">
                        ...
                        <div class="progress" style="height: p5x;">
                            <div class="progress-bar bg-warning progress-bar-striped progress-bar-animated" role="progressbar" aria-label="Example 1px high" style="width: 60%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">
                            </div>
                        </div>
                    </div>
                </div>
